...
|---|---|---|
| 1 | **VERIFIER_NUMBER** = huclose closer-queue **DID** | ViciDial → Inbound → DIDs (the number routed to the huclose in-group) |
| 2 | **SERVER_URL** = Vercel deployment URL + `/vapi` | Vercel dashboard → your project → Deployments |
